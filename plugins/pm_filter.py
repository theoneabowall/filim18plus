...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ɪꜰ yᴏᴜ ɴᴇᴇᴅ ᴍᴏᴠɪᴇ ᴊᴏɪɴ @videshayathra_official ᴀɴᴅ ᴀꜱᴋ !</b>")
    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                mh = await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[                          
                          InlineKeyboardButton("⚜️F18 ʟɪɴᴋꜱ⚜️", url='https://t.me/videshayathra_official')
                        ]]
                    )
                )
     ...
     #Any Ertors In Thos Code Contact @Master_broi
       ...
       await query.answer()
        ...
        buttons = [[
            InlineKeyboardButton('🪄ᴀʟʟ ᴏᴜʀ ʟɪɴᴋꜱ🪄', url="t.me/videshayathra_official")
       ],[
            InlineKeyboardButton('🎬ɢʀᴏᴜᴘ🎬', url="t.me/videshayathra_official"),
            InlineKeyboardButton('🏅ᴄʜᴀɴɴᴇʟ🏅', url="t.me/KOMOFFICIAL")
       ],[
            InlineKeyboardButton('📣ʙᴏᴛ ᴜᴩᴅᴀᴛᴇꜱ📣', url="t.me/filims_18"),
            InlineKeyboardButton('🤖ꜱᴜᴘᴘᴏʀᴛ🤖', url="https://t.me/filims_18SUPPORT")
       ],[
            InlineKeyboardButton('➕️ʜᴇʟᴩ➕️', url="t.me/Filims18bot")
       ],[ 
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⌫ ʙᴀᴄᴋ", callback_data="start"),
                    InlineKeyboardButton("☎️Cᴏɴᴛᴀᴄᴛ☎️", url="t.me/Christian_X_Grey")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
