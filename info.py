...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5840622348 6694407088 6756246365 6948618762').split()]
...
# Others
S_GROUP = environ.get('S_GROUP',"https://t.me/malluthund_0")
TMP_DOWNLOAD_DIRECTORY = environ.get("TMP_DOWNLOAD_DIRECTORY", "./DOWNLOADS/")
CHANNEL_ID = environ.get("CHANNEL_ID", "-1001896132048")
CHANNEL_LINK = environ.get('CHANNEL_LINK', 'https://t.me/+s3mdAOAD_bI3YmU1')
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/videshayathra_official')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/filims_18')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'malluthund_0')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), True)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{file_name}\n \n🎗️ʝσιи 🎗️ ѕнαяє🎗️ ѕυρρσят🎗️\nᴊᴏɪɴ ᴡɪᴛʜ ᴜs\n✯𝙅𝙊𝙄𝙉 :-⇊\nhttps://t.me/filims_18\n✯𝙅𝙊𝙄𝙉 :-⇊\nhttps://t.me/videshayathra_official\n🎗️ʝσιи 🎗️ ѕнαяє🎗️ ѕυρρσят🎗️\n")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "{file_name}\n\n🎗️ʝσιи 🎗️ ѕнαяє🎗️ ѕυρρσят🎗️\n• @videshayathra_official\n• @filims_18\n")
